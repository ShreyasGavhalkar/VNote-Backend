...
public class RegisterServlet extends HttpServlet {
	...
	//static final String pass; // Will be decided later
...
//		try (Connect conn = DriverManager.getConnection(url, user, password); Statement smt = conn.createStatement()) {
//			// checking for email in userauth, i am assuming passqord integrity is already
//			// verified
//			smt.executeUpdate("USE Vnote");
